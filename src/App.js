...
let homeTouchDown = i => setHomeScore(homeScore + 7) 
let awayTouchDown = i => setAwayScore(awayScore + 7) 
let homeFieldGoal = i => setHomeScore(homeScore + 3) 
let awayFieldGoal  = i => setAwayScore(awayScore + 3) 
  return (
